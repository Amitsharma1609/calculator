...
<body>
    <h1>Convertion Of Lenght</h1>

<form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post">
       
    <div class="set">
               <label for="fromConvertionUnit">From:</label>
               <input type="number" name="Lenght" id="Lenght" value="<?php echo (!empty($Lenght)) ? $Lenght : '' ?>">
    
               <select name="fromConvertionUnit" id="fromConvertionUnit">
                   <option value="Meter"  <?php if (isset($Lenght) &&  $fromConvertionUnit=="Meter") echo "selected";?>>Meter</option>
                   <option value="Kilometer"  <?php if (isset($Lenght) &&  $fromConvertionUnit=="Kilometer") echo "selected";?>>kilometer</option>
                   <option value="Centimeter"  <?php if (isset($Lenght) &&  $fromConvertionUnit=="Centimeter") echo "selected";?>>Centimeter</option>
                   <option value="Millimeter"  <?php if (isset($Lenght) &&  $fromConvertionUnit=="milliometer") echo "selected";?>>millimeter</option>
                   <option value="Mile"  <?php if (isset($Lenght) &&  $fromConvertionUnit=="Mile") echo "selected";?>>Mile</option>
                   <option value="Yard"  <?php if (isset($Lenght) &&  $fromConvertionUnit=="Yard") echo "selected";?>>Yard</option>
                   <option value="Foot"  <?php if (isset($Lenght) &&  $fromConvertionUnit=="Foot") echo "selected";?>>Foot</option>
                   <option value="Inch"  <?php if (isset($Lenght) &&  $fromConvertionUnit=="Inch") echo "selected";?>>Inch</option>
       ...
       <div class="toset">
               ...
               <input type="number" class="myname" value="<?php echo (!empty($ConvertLenght)) ? $ConvertLenght : '0' ?>">
               <select name="toConvertionUnit" id="toConvertionUnit">
                   <option value="Meter"  <?php if (isset($Lenght) &&  $toConvertionUnit=="Meter") echo "selected";?>>Meter</option>
                   <option value="Kilometer"  <?php if (isset($Lenght) &&  $toConvertionUnit=="Kilometer") echo "selected";?>>Kilometer</option>
                   <option value="Centimeter"  <?php if (isset($Lenght) &&  $toConvertionUnit=="Centimeter") echo "selected";?>>Centimeter</option>
                   <option value="Millimeter"  <?php if (isset($Lenght) &&  $toConvertionUnit=="Millimeter") echo "selected";?>>Millimeter</option>
                   <option value="Mile"  <?php if (isset($Lenght) &&  $toConvertionUnit=="Mile") echo "selected";?>>Mile</option>
                   <option value="Yard"  <?php if (isset($Lenght) &&  $toConvertionUnit=="Yard") echo "selected";?>>Yard</option>
                   <option value="Foot"  <?php if (isset($Lenght) &&  $toConvertionUnit=="Foot") echo "selected";?>>Foot</option>
                   <option value="Inch"  <?php if (isset($Lenght) &&  $toConvertionUnit=="Inch") echo "selected";?>>Inch</option>
               </select>
       </div>
        <div>
