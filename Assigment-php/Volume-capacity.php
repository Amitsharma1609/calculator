...
<body>
    <h1>Convertion Of Volume</h1>
    <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post">

        <div class="set">
            <label for="fromConvertionUnit">From:</label>
            <input type="number" name="Volume" id="Volume" value="<?php echo (!empty($Volume)) ? $Volume : '' ?>">

            <select name="fromConvertionUnit" id="fromConvertionUnit">
                <option value="Cubic Meter" <?php if (isset($Volume) && $fromConvertionUnit == "Cubic Meter") {
    echo "selected";
}
?>>Cubic Meter</option>
                <option value="Cubic Kilometer" <?php if (isset($Volume) && $fromConvertionUnit == "Cubic Kilometer") {
    echo "selected";
}
?>>kilometer</option>
                <option value="Cubic Centimeter" <?php if (isset($Volume) && $fromConvertionUnit == "Cubic Centimeter") {
    echo "selected";
}
?>>Cubic Centimeter</option>
                <option value="Cubic Mile" <?php if (isset($Volume) && $fromConvertionUnit == "Cubic Mile") {
    echo "selected";
}
?>>Cubic Mile</option>
                <option value="Cubic Yard" <?php if (isset($Volume) && $fromConvertionUnit == "Cubic Yard") {
    echo "selected";
}
?>>Cubic Yard</option>
                <option value="Cubic Foot" <?php if (isset($Volume) && $fromConvertionUnit == "Cubic Foot") {
    echo "selected";
}
?>>Cubic Foot</option>
                <option value="Cubic Inch" <?php if (isset($Volume) && $fromConvertionUnit == "Cubic Inch") {
    echo "selected";
}
?>>Cubic Inch</option>
 <option value="Liter" <?php if (isset($Volume) && $fromConvertionUnit == "Liter") {
    echo "selected";
}
?>>Liter</option>
        ...
        <div class="toset">
            ...
            <input type="number" class="myname" value="<?php echo (!empty($ConvertVolume)) ? $ConvertVolume : '0' ?>">
            <select name="toConvertionUnit" id="toConvertionUnit">
                <option value="Cubic Meter" <?php if (isset($Volume) && $toConvertionUnit == "Cubic Meter") {
    echo "selected";
}
?>>Cubic Meter</option>
                <option value="Cubic Kilometer" <?php if (isset($Volume) && $toConvertionUnit == "Cubic Kilometer") {
    echo "selected";
}
?>>Cubic Kilometer</option>
                <option value="Cubic Centimeter" <?php if (isset($Volume) && $toConvertionUnit == "Cubic Centimeter") {
    echo "selected";
}
?>>Cubic Centimeter</option>
                <option value="Cubic Mile" <?php if (isset($Volume) && $toConvertionUnit == "Cubic Mile") {
    echo "selected";
}
?>>Cubic Mile</option>
                <option value="Cubic Yard" <?php if (isset($Volume) && $toConvertionUnit == "Cubic Yard") {
    echo "selected";
}
?>>Cubic Yard</option>
                <option value="Cubic Foot" <?php if (isset($Volume) && $toConvertionUnit == "Cubic Foot") {
    echo "selected";
}
?>>Cubic Foot</option>
                <option value="Cubic Inch" <?php if (isset($Volume) && $toConvertionUnit == "Cubic Inch") {
    echo "selected";
}
?>>Cubic Inch</option>
  <option value="Liter" <?php if (isset($Volume) && $toConvertionUnit == "Liter") {
    echo "selected";
}
?>>Liter</option>
            </select>
