    ...
    <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post">
        ...
        <div class="set">
            ...
            <select name="fromConvertionUnit" id="fromConvertionUnit">
                <option value="Kilogram" <?php if (isset($Weight) && $fromConvertionUnit == "Kilogram") {
    echo "selected";
}
?>>Kilogram</option>
                <option value="Gram" <?php if (isset($Weight) && $fromConvertionUnit == "Gram") {
    echo "selected";
}
?>>
                    Gram</option>
                <option value="Pound" <?php if (isset($Weight) && $fromConvertionUnit == "Pound") {
    echo "selected";
}
?>> Pound</option>
                <option value="Milligram" <?php if (isset($Weight) && $fromConvertionUnit == "milliometer") {
    echo "selected";
}
?>>millimeter </option>
                <!-- <option value="Square Mile"  <?php if (isset($Weight) && $fromConvertionUnit == "Square Mile") {
    echo "selected";
}
?>>Square Mile</option>
                   <option value="Square Yard"  <?php if (isset($Weight) && $fromConvertionUnit == "Square Yard") {
    echo "selected";
}
?>>Square Yard</option> -->
                <option value="Metric Ton" <?php if (isset($Weight) && $fromConvertionUnit == "Metric Ton") {
    echo "selected";
}
?>>Metric Ton   </option>
                <option value="Carrat" <?php if (isset($Weight) && $fromConvertionUnit == "Carrat") {
    echo "selected";
}
?>> Carrat</option>
            </select>
        ...
        <div class="toset">
            ...
            <input type="number" class="myname" value="<?php echo (!empty($ConvertWeight)) ? $ConvertWeight : '0' ?>">
            <select name="toConvertionUnit" id="toConvertionUnit">
                <option value="Kilogram" <?php if (isset($Weight) && $toConvertionUnit == "Kilogram") {
    echo "selected";
}
?>> Kilogram</option>
                <option value="Gram" <?php if (isset($Weight) && $toConvertionUnit == "Gram") {
    echo "selected";
}
?>>Gram</option>
                <option value="Pound" <?php if (isset($Weight) && $toConvertionUnit == "Pound") {
    echo "selected";
}
?>>Pound</option>
                <option value="Milligram" <?php if (isset($Weight) && $toConvertionUnit == "Milligram") {
    echo "selected";
}
?>>Milligram</option>
                <!-- <option value="Square Mile"  <?php if (isset($Weight) && $toConvertionUnit == "Square Mile") {
    echo "selected";
}
?>>Square Mile</option>
                   <option value="Square Yard"  <?php if (isset($Weight) && $toConvertionUnit == "Square Yard") {
    echo "selected";
}
?>>Square Yard</option> -->
                <option value="Metric Ton" <?php if (isset($Weight) && $toConvertionUnit == "Metric Ton") {
    echo "selected";
}
?>>Metric Ton</option>
                <option value="Carrat" <?php if (isset($Weight) && $toConvertionUnit == "Carrat") {
    echo "selected";
}
?>> Carrat</option>
            </select>
