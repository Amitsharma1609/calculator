...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
   ...
   if($fromConvertionUnit == $toConvertionUnit){
    ...
    $ConvertArea = $Area * 0.0069444444;
}else if($fromConvertionUnit == 'Acre' && $toConvertionUnit == 'Square Centimeter') {
...
<body>
    <h1>Convertion Of Area</h1>
<form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post">
       
    <div class="set">
               <label for="fromConvertionUnit">From:</label>
               <input type="number" name="Area" id="Area" value="<?php echo (!empty($Area)) ? $Area : '' ?>">
    
               <select name="fromConvertionUnit" id="fromConvertionUnit">
                   <option value="Square Meter"  <?php if (isset($Area) &&  $fromConvertionUnit=="Square Meter") echo "selected";?>>Square Meter</option>
                   <option value="Square Kilometer"  <?php if (isset($Area) &&  $fromConvertionUnit=="Square Kilometer") echo "selected";?>>kilometer</option>
                   <option value="Square Centimeter"  <?php if (isset($Area) &&  $fromConvertionUnit=="Square Centimeter") echo "selected";?>>Square Centimeter</option>
                   <option value="Square Mile"  <?php if (isset($Area) &&  $fromConvertionUnit=="Square Mile") echo "selected";?>>Square Mile</option>
                   <option value="Square Yard"  <?php if (isset($Area) &&  $fromConvertionUnit=="Square Yard") echo "selected";?>>Square Yard</option>
                   <option value="Square Foot"  <?php if (isset($Area) &&  $fromConvertionUnit=="Square Foot") echo "selected";?>>Square Foot</option>
                   <option value="Square Inch"  <?php if (isset($Area) &&  $fromConvertionUnit=="Square Inch") echo "selected";?>>Square Inch</option>
       ...
       <div class="toset">
               ...
               <input type="number" class="myname" value="<?php echo (!empty($ConvertArea)) ? $ConvertArea : '0' ?>">
               <select name="toConvertionUnit" id="toConvertionUnit">
                   <option value="Square Meter"  <?php if (isset($Area) &&  $toConvertionUnit=="Square Meter") echo "selected";?>>Square Meter</option>
                   <option value="Square Kilometer"  <?php if (isset($Area) &&  $toConvertionUnit=="Square Kilometer") echo "selected";?>>Square Kilometer</option>
                   <option value="Square Centimeter"  <?php if (isset($Area) &&  $toConvertionUnit=="Square Centimeter") echo "selected";?>>Square Centimeter</option>
                   <option value="Square Mile"  <?php if (isset($Area) &&  $toConvertionUnit=="Square Mile") echo "selected";?>>Square Mile</option>
                   <option value="Square Yard"  <?php if (isset($Area) &&  $toConvertionUnit=="Square Yard") echo "selected";?>>Square Yard</option>
                   <option value="Square Foot"  <?php if (isset($Area) &&  $toConvertionUnit=="Square Foot") echo "selected";?>>Square Foot</option>
                   <option value="Square Inch"  <?php if (isset($Area) &&  $toConvertionUnit=="Square Inch") echo "selected";?>>Square Inch</option>
               </select>
       </div>
        <div>
